...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerXCs3HUx\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerXCs3HUx/getWebpackEncore_TagRendererService.php';
require __DIR__.'/ContainerXCs3HUx/getWebpackEncore_ExceptionListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getWebpackEncore_EntrypointLookupDefaultService.php';
require __DIR__.'/ContainerXCs3HUx/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerXCs3HUx/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerXCs3HUx/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerXCs3HUx/getVichUploader_UploadHandlerService.php';
require __DIR__.'/ContainerXCs3HUx/getVichUploader_Listener_Upload_CarsService.php';
require __DIR__.'/ContainerXCs3HUx/getVichUploader_Form_Type_ImageService.php';
require __DIR__.'/ContainerXCs3HUx/getVichUploader_Form_Type_FileService.php';
require __DIR__.'/ContainerXCs3HUx/getVichUploader_DownloadHandlerService.php';
require __DIR__.'/ContainerXCs3HUx/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerXCs3HUx/getValidator_ExpressionService.php';
require __DIR__.'/ContainerXCs3HUx/getValidator_EmailService.php';
require __DIR__.'/ContainerXCs3HUx/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerXCs3HUx/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerXCs3HUx/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerXCs3HUx/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerXCs3HUx/getTwig_Form_EngineService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerXCs3HUx/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerXCs3HUx/getTexter_TransportsService.php';
require __DIR__.'/ContainerXCs3HUx/getSymfonycasts_ResetPassword_CleanerService.php';
require __DIR__.'/ContainerXCs3HUx/getSession_FactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getServicesResetterService.php';
require __DIR__.'/ContainerXCs3HUx/getSerializer_Mapping_ClassMetadataFactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getSerializerService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_UserPasswordHasherService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_UserAuthenticatorService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_Authenticator_Manager_MainService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_AccessMapService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getSecrets_VaultService.php';
require __DIR__.'/ContainerXCs3HUx/getRouting_LoaderService.php';
require __DIR__.'/ContainerXCs3HUx/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerXCs3HUx/getPropertyAccessorService.php';
require __DIR__.'/ContainerXCs3HUx/getNotifier_TransportFactory_NullService.php';
require __DIR__.'/ContainerXCs3HUx/getMonolog_Logger_MessengerService.php';
require __DIR__.'/ContainerXCs3HUx/getMonolog_Logger_MailerService.php';
require __DIR__.'/ContainerXCs3HUx/getMimeTypesService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_TransportFactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Transport_Sync_FactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Transport_FailedService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Transport_Doctrine_FactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Transport_AsyncService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_RoutableMessageBusService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Retry_SendFailedMessageForRetryListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Retry_MultiplierRetryStrategy_FailedService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Retry_MultiplierRetryStrategy_AsyncService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Middleware_SendMessageService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Listener_StopWorkerOnSigtermSignalListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Listener_StopWorkerOnRestartSignalListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Failure_SendFailedMessageToFailureTransportListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Bus_Default_Middleware_TraceableService.php';
require __DIR__.'/ContainerXCs3HUx/getMessenger_Bus_Default_Middleware_HandleMessageService.php';
require __DIR__.'/ContainerXCs3HUx/getMailer_TransportsService.php';
require __DIR__.'/ContainerXCs3HUx/getMailer_TransportFactory_SmtpService.php';
require __DIR__.'/ContainerXCs3HUx/getMailer_TransportFactory_SendmailService.php';
require __DIR__.'/ContainerXCs3HUx/getMailer_TransportFactory_NullService.php';
require __DIR__.'/ContainerXCs3HUx/getMailer_TransportFactory_NativeService.php';
require __DIR__.'/ContainerXCs3HUx/getMailer_MailerService.php';
require __DIR__.'/ContainerXCs3HUx/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_Type_FormService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_Type_FileService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_Type_EntityService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_Type_ColorService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_ServerParamsService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_RegistryService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_FactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerXCs3HUx/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerXCs3HUx/getErrorControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_Orm_Messenger_EventSubscriber_DoctrineClearEntityManagerService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_Orm_Messenger_DoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaSubscriberService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerXCs3HUx/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurityVoterService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerXCs3HUx/getBatchActionDtoResolverService.php';
require __DIR__.'/ContainerXCs3HUx/getAdminContextResolverService.php';
require __DIR__.'/ContainerXCs3HUx/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerXCs3HUx/getContainer_GetenvService.php';
require __DIR__.'/ContainerXCs3HUx/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerXCs3HUx/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerXCs3HUx/getCache_SystemClearerService.php';
require __DIR__.'/ContainerXCs3HUx/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerXCs3HUx/getCache_AppClearerService.php';
require __DIR__.'/ContainerXCs3HUx/getTransliteratorService.php';
require __DIR__.'/ContainerXCs3HUx/getUniqidNamerService.php';
require __DIR__.'/ContainerXCs3HUx/getSubdirDirectoryNamerService.php';
require __DIR__.'/ContainerXCs3HUx/getSmartUniqueNamer_CarsService.php';
require __DIR__.'/ContainerXCs3HUx/getSmartUniqueNamerService.php';
require __DIR__.'/ContainerXCs3HUx/getPropertyNamerService.php';
require __DIR__.'/ContainerXCs3HUx/getPropertyDirectoryNamerService.php';
require __DIR__.'/ContainerXCs3HUx/getOrignameNamerService.php';
require __DIR__.'/ContainerXCs3HUx/getHashNamerService.php';
require __DIR__.'/ContainerXCs3HUx/getCurrentDateTimeDirectoryNamerService.php';
require __DIR__.'/ContainerXCs3HUx/getBase64NamerService.php';
require __DIR__.'/ContainerXCs3HUx/getTemplateControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getRedirectControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getFieldProviderService.php';
require __DIR__.'/ContainerXCs3HUx/getEntityUpdaterService.php';
require __DIR__.'/ContainerXCs3HUx/getEntityRepositoryService.php';
require __DIR__.'/ContainerXCs3HUx/getFiltersFormTypeService.php';
require __DIR__.'/ContainerXCs3HUx/getFileUploadTypeService.php';
require __DIR__.'/ContainerXCs3HUx/getCrudFormTypeService.php';
require __DIR__.'/ContainerXCs3HUx/getEaCrudFormTypeExtensionService.php';
require __DIR__.'/ContainerXCs3HUx/getNumberConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getMoneyConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getDateTimeConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getCountryConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getCommonPreConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getCommonPostConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getCollectionConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getBooleanConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getAssociationConfiguratorService.php';
require __DIR__.'/ContainerXCs3HUx/getPaginatorFactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getFormFactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getFilterFactoryService.php';
require __DIR__.'/ContainerXCs3HUx/getExceptionListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getCrudResponseListenerService.php';
require __DIR__.'/ContainerXCs3HUx/getAssetPackageService.php';
require __DIR__.'/ContainerXCs3HUx/getProfilerControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getLoginAuthenticatorService.php';
require __DIR__.'/ContainerXCs3HUx/getUserRepositoryService.php';
require __DIR__.'/ContainerXCs3HUx/getResetPasswordRequestRepositoryService.php';
require __DIR__.'/ContainerXCs3HUx/getCarsRepositoryService.php';
require __DIR__.'/ContainerXCs3HUx/getBrandRepositoryService.php';
require __DIR__.'/ContainerXCs3HUx/getResetPasswordRequestFormTypeService.php';
require __DIR__.'/ContainerXCs3HUx/getRegistrationFormTypeService.php';
require __DIR__.'/ContainerXCs3HUx/getContactTypeService.php';
require __DIR__.'/ContainerXCs3HUx/getChangePasswordFormTypeService.php';
require __DIR__.'/ContainerXCs3HUx/getSecurityControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getResetPasswordControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getRegistrationControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getInfosControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getHomeControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getContactControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getCarsControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getBrandControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getDashboardControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getCarsCrudControllerService.php';
require __DIR__.'/ContainerXCs3HUx/getBrandCrudControllerService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_Zyi9m0BService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_WcyNGhyService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_TOz6_QCService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_Q6hAO0Service.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_L2QwsaZService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_L1ae_QzService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_C7f47p7Service.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_BgOZrService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_ZOQ9v2dService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_UDgw6OlService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_U4BbnsnService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_TB2K_KGService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_OlybskbService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_Nt_OgDbService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_LDa1AvTService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_G7J5V9iService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_D4nGOutService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_CpaXrFhService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_CRElsISService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_CKlWSjaService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_4C0Bh8jService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_3on9uHLService.php';
require __DIR__.'/ContainerXCs3HUx/get_ServiceLocator_2dc0eaXService.php';
require __DIR__.'/ContainerXCs3HUx/get_Messenger_HandlerDescriptor_VMw0m61Service.php';
require __DIR__.'/ContainerXCs3HUx/get_Messenger_HandlerDescriptor_TGvt0LHService.php';
require __DIR__.'/ContainerXCs3HUx/get_Messenger_HandlerDescriptor_XZowc_TService.php';
require __DIR__.'/ContainerXCs3HUx/get_Messenger_HandlerDescriptor_Lml2ICsService.php';
...
$classes[] = 'App\Repository\CarsRepository';
