 ...
 */
class getVichUploader_Listener_Upload_CarsService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.upload.cars' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.upload.cars'])) {
            return $container->privates['vich_uploader.listener.upload.cars'];
        }

        return $container->privates['vich_uploader.listener.upload.cars'] = new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('cars', new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter(), ($container->privates['vich_uploader.metadata_reader'] ?? $container->getVichUploader_MetadataReaderService()), $a);
    }
}
